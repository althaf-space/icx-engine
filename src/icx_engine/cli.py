...
def workstatus_add_time_cmd(
    ...
    from_time: Annotated[str, typer.Option("--from", help="full datetime, e.g. '2026-08-07 09:30:00'")],
    to_time: Annotated[str, typer.Option("--to", help="full datetime, e.g. '2026-08-07 17:30:00'")],
