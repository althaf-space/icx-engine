...
def _meta():
    return {"app": "magik_ui", "url": "http://x/#/users", "test_type": "ui", "ts": 1000.0, "run_id": "r1"}
...
def test_write_never_raises_on_bad_dir(tmp_path):
    ...
    p = write_session_report({}, {"app": "x", "url": "", "test_type": "ui", "ts": 0.0, "run_id": "r"},
...
def test_write_never_raises_on_non_numeric_ts(tmp_path):
    meta = {"app": "x", "url": "", "test_type": "ui", "ts": "not-a-number", "run_id": "r"}
...
def test_update_index_tolerant_of_bad_ts_row(tmp_path):
    good = {"run_id": "r1", "app": "a1", "url": "", "test_type": "ui", "ts": 1000,
            "total": 2, "passed": 2, "failed": 0, "skipped": 0, "pass_rate": 100, "file": "a1-1000.html"}
    bad = {"run_id": "r2", "app": "a2", "url": "", "test_type": "ui", "ts": "bad",
